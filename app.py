...
aio = Client('12_123', 'aio_tIpW49RjbR66PPnWgaJyie5ZylSJ')
...
def demo2(bot,update):
   bot.message.reply_text('My name is thiefbook-bot')
...
BOT_TOKEN = '1945012232:AAH_ee4UK212ZI-3ZzoMM1cz-icAeuXMAZ8'
